...
const CreatePlaylistModal = ({closeModal}) =>{
    ...
    return(
        ...
        <div className="absolute bg-black w-screen h-screen bg-opacity-50 flex justify-center items-center" onClick={closeModal}>
            <div className="bg-app-black w-1/3 rounded p-4" onClick={(e) =>{e.stopPropagation()}}>
                ...
                <div className="space-y-4 flex flex-col justify-center items-center">
                    ...
                    />
                    <div className="bg-white w-1/3 rounded flex font-semibold justify-center items-center py-3 mt-5" onClick={createPlaylist}>Create</div>
                </div>
            </div>
        </div>
    )
